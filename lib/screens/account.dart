...
class AccountPage extends StatelessWidget {
  void _showDocument(BuildContext context, String path) {
    showDialog(
        context: context,
        builder: (context) {
          return Padding(
            ...
            child: PhotoView(
              ...
              tightMode: true,
              imageProvider: NetworkImage('$BASE_URL$path'),
                        ...
                        child: Column(
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                userNotifier.user?.basicInformation?.phone ??
                                    'Телефон',
                                style: TextStyle(
                                    fontSize: 12.0,
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 4.0),
                              Text(
                                userNotifier.user?.basicInformation?.email ??
                                    'Пошта',
                                style: TextStyle(
                                    fontSize: 12.0,
                                    fontWeight: FontWeight.w600),
              ...
              Card(
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    ...
                    Text('Місто',
                        style: TextStyle(
                            fontSize: 12.0, color: Color(0xFFA1A1A1))),
                    const SizedBox(height: 8.0),
                    ...
                    const SizedBox(height: 8.0),
                    Text(
                        userNotifier.user?.specializedInformation?.workplace ??
                            '',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Divider(),
                    Text('Спеціалізація',
                    ...
                    Text(
                        userNotifier
                                .user?.specializedInformation?.specification ??
                            '',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Divider(),
                    Text('Рівень кваліфікації',
                        style: TextStyle(
                            fontSize: 12.0, color: Color(0xFFA1A1A1))),
                    const SizedBox(height: 8.0),
                    Text(
                        userNotifier
                                .user?.specializedInformation?.qualification ??
                            '',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Divider(),
                    Text('Посада',
                    ...
                    const SizedBox(height: 8.0),
                    Text(
                        userNotifier.user?.specializedInformation?.position ??
                            '',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Divider(),
                    Text('Номер ліцензії лікаря',
                        style: TextStyle(
                            fontSize: 12.0, color: Color(0xFFA1A1A1))),
                    const SizedBox(height: 8.0),
                    Text(
                        userNotifier
                                .user?.specializedInformation?.licenseNumber ??
                            '',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Divider(),
                    ...
                    InkWell(
                      onTap: () async {
                        if (userNotifier.user.specializedInformation.micId !=
                            null) {
                          _showDocument(
                            context,
                      ...
                      onTap: () async {
                        if (userNotifier.user.specializedInformation.micId !=
                          ...
                          _showDocument(
                            context,
                            userNotifier
                                .user.specializedInformation.passport.path,
                          );
                        }
                      },
                      child: Row(
                    ...
                    InkWell(
                      onTap: () async {
                        if (userNotifier.user.specializedInformation.micId !=
                          ...
                          _showDocument(
                            context,
                            userNotifier.user.specializedInformation.micId.path,
                          );
                        }
                      },
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                                userNotifier.user?.specializedInformation?.micId
                                        ?.fileName ??
                                    '',
                                style: TextStyle(
                                    color: Theme.of(context).primaryColor)),
