        ...
        body: Consumer<UserNotifier>(builder: (context, userNotifier, _) {
          return HookBuilder(builder: (context) {
            ...
            final nameController = useTextEditingController(
                text: userNotifier.user?.basicInformation?.name);
            final phoneController = useTextEditingController(
                text: userNotifier.user?.basicInformation?.phone);
            final postController = useTextEditingController(
                text: userNotifier.user?.basicInformation?.email);

            final specificationController = useTextEditingController(
            ...
            final additionalQualificationController = useTextEditingController(
                text: userNotifier
                    .user?.specializedInformation?.additionalQualification);
            ...
            final hospitalController = useTextEditingController(
                    ...
                    children: [
                      ...
                      Card(
                          ...
                          child: Row(children: [
                            InkResponse(
                              onTap: () async {
                                var path = await showCameraGalleryChooseDialog(
                                    context);
                              ...
                              child: Padding(
                                ...
                                child: OctoCircleAvatar(
                                  url: userNotifier.user?.basicInformation
                            ...
                            child: Container(
                              ...
                              child: ExpansionTile(
                                ...
                                childrenPadding: EdgeInsets.symmetric(
                                    horizontal: 8.0.w, vertical: 1.0.h),
                                ...
                                children: [
                                  ...
                                  DocumentsContainer(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        isLoading.value = true;
                                        final resultFile =
                                            await FileUtils.renameBaseFile(
                                                result.path, 'edu_doc');
                                        userNotifier
                                  ...
                                  DocumentsContainer(
                                    doc: userNotifier
                                        .user?.specializedInformation?.passport,
                                    onDeleteTap: () {
                                    ...
                                    onTap: () async {
                                      ...
                                      if (result != null) {
                                        ...
                                        final resultFile =
                                            await FileUtils.renameBaseFile(
                                                result.path, 'passport');
                                        userNotifier
                                            .uploadPassport(resultFile.path)
                                            .then((_) {
                                          isLoading.value = false;
                                        }).catchError((error) {
                                          isLoading.value = false;
                                  ...
                                  DocumentsContainer(
                                    doc: userNotifier
                                        .user?.specializedInformation?.micId,
                                    onDeleteTap: () {
                      ...
                      Card(
                          ...
                          child: IgnorePointer(
                            ...
                            child: Container(
                              ...
                              child: ExpansionTile(
                                title:
                                    Text('Фінансова інформація'.toUpperCase(),
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        )),
                                initiallyExpanded: true,
                              ...
                              if (_basicInfoFormKey.currentState.validate() &&
                                ...
                                result['specialized_information'] = {
                                  ...
                                  'additional_qualification':
                                      additionalQualificationController.text,
                                };
