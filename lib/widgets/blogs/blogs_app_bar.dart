...
class BlogsAppBar extends HookWidget implements PreferredSizeWidget {
  @override
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: () => blogsNotifier.changePage(BlogPage.NEWS),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: AnimatedDefaultTextStyle(
                          duration: Duration(milliseconds: 200),
                          style: blogsNotifier.page == BlogPage.NEWS
                              ? Theme.of(context)
                                  .textTheme
                                  .bodyText2
                    ...
                    InkWell(
                      onTap: () => blogsNotifier.changePage(BlogPage.INFORMATION),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: AnimatedDefaultTextStyle(
                          duration: Duration(milliseconds: 200),
                          style: blogsNotifier.page == BlogPage.INFORMATION
                              ? Theme.of(context)
                                  .textTheme
                                  .bodyText2
                                  .copyWith(fontWeight: FontWeight.w800, fontSize: 17.0)
